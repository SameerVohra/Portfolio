function About() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 p-8 font-mono">
      <div className="bg-gray-800 p-6 rounded-xl shadow-lg w-full max-w-2xl">
        <h1 className="text-white text-4xl font-bold mb-6 text-center">About Me</h1>
